...
\subsubsection*{Activity: The Importance of the Film Journal}\label{activity-the-importance-of-the-film-journal}}
\addcontentsline{toc}{subsubsection}{Activity: The Importance of the Film Journal}
...
\subsubsection*{Activity: Read and Reflect}\label{activity-read-and-reflect}}
\addcontentsline{toc}{subsubsection}{Activity: Read and Reflect}
...
\subsubsection*{Activity: Reflection}\label{activity-reflection}}
\addcontentsline{toc}{subsubsection}{Activity: Reflection}
...
\subsubsection*{Course Journal}\label{course-journal}}
\addcontentsline{toc}{subsubsection}{Course Journal}
...
\subsubsection*{Activity: Shooting a Film}\label{activity-shooting-a-film}}
\addcontentsline{toc}{subsubsection}{Activity: Shooting a Film}
...
\subsubsection*{Activity: Reflect and Share}\label{activity-reflect-and-share}}
\addcontentsline{toc}{subsubsection}{Activity: Reflect and Share}
...
\addcontentsline{toc}{subsection}{Elements of Composition}
...
\subsubsection*{Activity: Readings on Techniques and Principles of Composition}\label{activity-readings-on-techniques-and-principles-of-composition}}
\addcontentsline{toc}{subsubsection}{Activity: Readings on Techniques and Principles of Composition}
...
\subsubsection*{Activity: Read and Explore}\label{activity-read-and-explore}}
\addcontentsline{toc}{subsubsection}{Activity: Read and Explore}
...
\addcontentsline{toc}{subsubsection}{Watch and Learn}
...
\addcontentsline{toc}{subsubsection}{Activity: Proper Motivation Exercise and Practice}
...
\item
  Read and Study Chapter 5, and a web essay on how to build your intuition such as \href{https://liveboldandbloom.com/04/self-improvement/develop-your-intuition}{21 Eye-Opening Ways To Develop Your Intuition}
\item
  Read the next section of Chapter 5 and John Suler's Photographic Psychology: Image and Psyche, Camera Angles.
\end{itemize}
...
\begin{reflect}
\hypertarget{watch-and-learn-1}{%
\subsubsection*{Watch and Learn}\label{watch-and-learn-1}}
\addcontentsline{toc}{subsubsection}{Watch and Learn}
...
\addcontentsline{toc}{subsection}{Camera Angles and Heights}
...
\subsection*{Camera Subject Angles}\label{camera-subject-angles}}
\addcontentsline{toc}{subsection}{Camera Subject Angles}
...
Next, study a web essay on how to build your intuition such as \href{https://liveboldandbloom.com/04/self-improvement/develop-your-intuition}{21 Eye-Opening Ways To Develop Your Intuition}
...
\tightlist
\item
  \textbf{Read, Study, and Reflect:} Read and study Chapter 6 of course e-text: \emph{Digital Filmmaking: A Beginner's Guide to Mastering the Craft.} Write in your journal your initial thoughts regarding the benefits of doing an in-camera film
\item
  \textbf{Brainstorming:} Brainstorm at least five story ideas and use the ``Fairy Tale Template for a Short Film'' to write your story for your short film.
\end{itemize}

\emph{Note that these learning activities are ungraded, but designed to help you succeed in your assessments in this course.}
\end{reflect}
...
\begin{reflect}
\hypertarget{read-study-and-reflect}{%
\subsubsection*{Read, Study and Reflect}\label{read-study-and-reflect}}
\addcontentsline{toc}{subsubsection}{Read, Study and Reflect}
...
\addcontentsline{toc}{subsection}{Picture Cutting Techniques}
...
\addcontentsline{toc}{subsection}{Types of Montage Projects}
...
\addcontentsline{toc}{subsubsection}{Read, Study, and Explore}
...
\addcontentsline{toc}{subsection}{Pitching Your Montage Project}
...
\addcontentsline{toc}{subsubsection}{Read and Review}
...
\addcontentsline{toc}{subsubsection}{Read and Study}
...
\addcontentsline{toc}{subsubsection}{Self-Assessment}
...
\subsubsection*{Assessment:}\label{assessment-13}}
