...
- VIDEO EDITING TRANSITIONS (Taylor Cut Tutorial)
- Critiquing Your Short Films
...
Then, read the first section in Chapter 7, the Post-Production Workflow. For a detailed overview of the post-production process, watch the video [*Stages of Post Production for Filmmaking in Cinema*](https://www.youtube.com/watch?v=IFjyVW21Vpw){target="_blank"} [@wolfcrowStagesPostProduction2016] <!-- Auto title, auto embed--> 
...
[“20 Montages That Might Be The Best Part Of The Movie”](https://www.refinery29.com/en-us/best-movie-montages) [@weiss20MontagesThat]
...
You can use J-cut and L-cuts when you are working with dialogue or you want to lead into a new shot or scene or carry the audio to a new shot or scene. If you are interested in doing this, watch the video [*Film Making 101 Tutorial - L & J Cuts*](https://www.youtube.com/watch?v=PAvJevWUVsc){target="_blank"} [@surfacedstudioFilmMaking1012016] <!-- Auto title, auto embed--> 
...
[Watch: *Cuts Every Video Editor Should Know | Filmmaking Tips*](https://www.youtube.com/watch?v=Wv3Hmf2Dxlo){target="_blank"} [@shutterstocktutorials9CutsEvery2018] <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/Wv3Hmf2Dxlo >}}

[Watch: *Cuts & Transitions 101*](https://www.youtube.com/watch?v=OAH0MoAv2CI){target="_blank"} [@rocketjumpfilmschoolCutsTransitions1012016]

{{< video https://www.youtube-nocookie.com/embed/OAH0MoAv2CI?si=awfJvhh6OwRp3xfl >}}

**Optional**: For an excellent example of a nature and time-lapse montage where a series of images are synced into a powerful soundtrack , watch the video [“Pursuit - A 4K storm time-lapse film”](https://www.youtube.com/watch?v=oagszCmJLpU){target="_blank"} [@mikeolbinskiphotographyPursuit4KStorm2017]. As you view it, pay attention to the way the types and rhythms of the images flow and work in sync with the music and sound effects especially from 2: 29 onward.
...
For insight into how to critique a short film watch the video [*Critiquing Your Short Films*](https://www.youtube.com/watch?v=x5ASDkOSIBE){target="_blank"} [@filmriotCritiquingYourShort2018] <!-- Auto title, auto embed--> 
