...
Then, read the first section in Chapter 7, the Post-Production Workflow. For a detailed overview of the post-production process, watch the video [*Stages of Post Production for Filmmaking in Cinema*](https://www.youtube.com/watch?v=IFjyVW21Vpw){target="_blank"} <!-- Auto title, auto embed--> 
...
For insight into how to critique a short film watch the video [*Critiquing Your Short Films*](https://www.youtube.com/watch?v=x5ASDkOSIBE){target="_blank"} <!-- Auto title, auto embed--> 
