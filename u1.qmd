...
2.  Excellence and Professional and Personal Development
3.  15 Tips for Doing Your Best
...
-   Introduction and Chapter One of the course text: *Digital Filmmaking: A Beginner’s Guide to Mastering the Craft*, by Ned Vankevich [-@VankevichDigitalFilmmaking] (e-text)
-   How to Start a Creative Journal (Be sure to click on the internal links on this website)
-   Watch: *How to Journal Every Day for Increased Productivity, Clarity, and Mental Health*
...
-   Entry Two:Study the recommended how-to-write-a-journal resources and log what you learned from them and how it will help you during the course.
    ...
    -   [Watch: *How to Journal Every Day for Increased Productivity, Clarity, and Mental Health*](https://www.youtube.com/watch?v=hUTWo7_W0lc){target="_blank"} [@mattraglandHowJournalEvery2018] <!-- Auto title, auto embed-->
...
### Activity: Film Terms and Vocabulary Needed for this Course
...
::: note
HELPFUL HINT: For insight into how great artists, athletes, and performers use mistakes to grow in their art and craft see the following book by Daniel Coyle: [The Talent Code: Greatness Isn’T Born. It’S Grown. Here’S How](http://danielcoyle.com/the-talent-code/){target="_blank"} [@TalentCode].
:::
...
[How To Grow Professionally](https://brandyourself.com/blog/guide/how-to-grow-professionally/){target="_blank"} [@keiserHowGrowProfessionally2018]
:::
...
### Activity: Reflection on Life Skills

:::: learning-activity

- Which of the life skills above are important to you and why? Log this in your journal. 
- Which life skill(s) can you add to the list? Share your responses with your Facilitator and classmates.
